    ...
    def test_search_web_recipes(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                # Store first recipe URL for import test
                if recipes:
                    self.test_recipe_url = recipes[0]['url']
            ...
            if response.status_code == 200:
                ...
                for i, ing in enumerate(ingredients):
                    ...
                    if not isinstance(ing['quantity'], (int, float)) or ing['quantity'] <= 0:
                        print(f"❌ Failed - Ingredient {i} quantity is not a valid number")
                        return False
                ...
                for i, ing in enumerate(ingredients[:3]):
                    print(f"   Ingredient {i+1}: {ing['quantity']} {ing['unit']} {ing['name']}")
